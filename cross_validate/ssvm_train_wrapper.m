...
% function [weights, b] = ssvm_train_wrapper (data, labels, c, varargin)
%
% Wrapper for training a Sparse SVM through sparse_svm_train, for
...
%   - varargin: all extra parameters are forwarded to sparse_svm_train.
% OUTPUTS:
...
[weights, b] = sparse_svm_train (data', labels_conv', c, varargin{:});